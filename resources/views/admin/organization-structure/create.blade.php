...
<div class="container py-4">
    <div class="page-inner">
        ...
        <div class="page-header mb-4">
            ...
            <h3 class="page-title mb-0 fw-bold text-dark"><i class="fas fa-plus-circle me-2"></i> Tambah Unit Organisasi</h3>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mb-3">
                                    <label for="image" class="form-label fw-medium">Upload Gambar</label>
                            ...
                            <div class="alert alert-info">
                                ...
                                <ul class="mb-0 small">
                                    ...
                                    <li>Logo/gambar akan ditampilkan dalam struktur organisasi</li>
                                </ul>
                            </div>
                        </div>
                    </div>
