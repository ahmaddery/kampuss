        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Edit Data Visi Misi</h4>
                    <a href="{{ route('admin.visi-misi.index') }}" class="btn btn-secondary">
                        <i class="fas fa-arrow-left"></i> Kembali
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.visi-misi.update', $visionMission->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                        ...
                                        <option value="intro" {{ old('type', $visionMission->type) == 'intro' ? 'selected' : '' }}>Intro/Pembuka</option>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3" id="title-field">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                           id="title" name="title" value="{{ old('title', $visionMission->title) }}">
                                    @error('title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="5" required>{{ old('description', $visionMission->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3" id="order-field" style="display: none;">
                                    ...
                                    <input type="number" class="form-control @error('order') is-invalid @enderror" 
                                           id="order" name="order" value="{{ old('order', $visionMission->order) }}" min="1">
                                    @error('order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3" id="year-field" style="display: none;">
                                    ...
                                    <input type="number" class="form-control @error('year_target') is-invalid @enderror" 
                                           id="year_target" name="year_target" value="{{ old('year_target', $visionMission->year_target) }}" 
                                           min="2020" max="2050">
                                    @error('year_target')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3" id="image-field" style="display: none;">
                            ...
                            @if($visionMission->image_path)
                                <div class="mb-2">
                                    <img src="{{ $visionMission->image_url }}" alt="Current Image" class="img-thumbnail" style="max-width: 200px;">
