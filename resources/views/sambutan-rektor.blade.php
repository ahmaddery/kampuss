...
<section class="detailed-content-section">
    <div class="container">
        <div class="article-header fade-up">
            <div class="article-category">Program & Inisiatif</div>
            <h2 class="article-title">Fokus Kepemimpinan</h2>
        </div>
        
        <div class="content-grid">
            @if(isset($data[0]->program_unggulan) && !empty($data[0]->program_unggulan))
                <div class="content-card fade-up">
                    <div class="content-icon">
                        <i class="fas fa-star"></i>
                    </div>
                    <h3 class="content-title">Program Unggulan</h3>
                    <div class="content-text">
                        {!! $data[0]->program_unggulan !!}
                    </div>
                </div>
            @endif
            
            @if(isset($data[0]->inovasi_pendidikan) && !empty($data[0]->inovasi_pendidikan))
                <div class="content-card fade-up">
                    <div class="content-icon">
                        <i class="fas fa-lightbulb"></i>
                    </div>
                    <h3 class="content-title">Inovasi Pendidikan</h3>
                    <div class="content-text">
                        {!! $data[0]->inovasi_pendidikan !!}
                    </div>
                </div>
            @endif
            
            @if(isset($data[0]->kemitraan) && !empty($data[0]->kemitraan))
                <div class="content-card fade-up">
                    <div class="content-icon">
                        <i class="fas fa-handshake"></i>
                    </div>
                    <h3 class="content-title">Kemitraan Strategis</h3>
                    <div class="content-text">
                        {!! $data[0]->kemitraan !!}
                    </div>
                </div>
            ...
            @if(isset($data[0]->penelitian_unggulan) && !empty($data[0]->penelitian_unggulan))
                <div class="content-card fade-up">
                    <div class="content-icon">
                        <i class="fas fa-microscope"></i>
                    </div>
                    <h3 class="content-title">Penelitian Unggulan</h3>
                    <div class="content-text">
                        {!! $data[0]->penelitian_unggulan !!}
                    </div>
                </div>
            @endif
            
            @if(isset($data[0]->pengabdian_masyarakat) && !empty($data[0]->pengabdian_masyarakat))
                <div class="content-card fade-up">
                    <div class="content-icon">
                        <i class="fas fa-users"></i>
                    </div>
                    <h3 class="content-title">Pengabdian Masyarakat</h3>
                    <div class="content-text">
                        {!! $data[0]->pengabdian_masyarakat !!}
                    </div>
                </div>
            @endif
            
            @if(isset($data[0]->target_capaian) && !empty($data[0]->target_capaian))
                <div class="content-card fade-up">
                    <div class="content-icon">
                        <i class="fas fa-bullseye"></i>
                    </div>
                    <h3 class="content-title">Target Capaian</h3>
                    <div class="content-text">
                        {!! $data[0]->target_capaian !!}
                    </div>
                </div>
            @endif
        </div>
...
<section class="vision-mission-section">
    <div class="container">
        <div class="article-header fade-up">
            <div class="article-category" style="color: #ffd700;">Filosofi Kepemimpinan</div>
            <h2 class="article-title" style="color: #fff;">Visi & Misi dalam Memimpin</h2>
        </div>
        ...
        <div class="vm-grid">
            <div class="vm-card fade-up">
                ...
                <h3 class="vm-title">Visi Kepemimpinan</h3>
                <p class="vm-text">
                    @if(isset($data) && count($data) > 0 && isset($data[0]->visi_kepemimpinan) && !empty($data[0]->visi_kepemimpinan))
                        {{ $data[0]->visi_kepemimpinan }}
                    @else
                        Memimpin transformasi pendidikan tinggi menuju keunggulan yang berkelanjutan, 
                        menciptakan ekosistem akademik yang inovatif, dan menghasilkan lulusan yang 
                        kompeten serta berkarakter untuk menghadapi tantangan global.
                    @endif
                </p>
            </div>
            ...
            <div class="vm-card fade-up" style="animation-delay: 0.2s;">
                ...
                <h3 class="vm-title">Misi Kepemimpinan</h3>
                <p class="vm-text">
                    @if(isset($data) && count($data) > 0 && isset($data[0]->misi_kepemimpinan) && !empty($data[0]->misi_kepemimpinan))
                        {{ $data[0]->misi_kepemimpinan }}
                    @else
                        Mengembangkan budaya akademik yang unggul, membangun kemitraan strategis, 
                        mendorong inovasi dalam pembelajaran dan penelitian, serta menciptakan 
                        lingkungan yang kondusif untuk pertumbuhan intelektual dan pengembangan karakter.
                    @endif
                </p>
            </div>
        </div>
...
<section class="stats-section">
    <div class="container">
        <div class="article-header fade-up">
            <div class="article-category">Pencapaian</div>
            <h2 class="article-title">Prestasi dalam Angka</h2>
        </div>
        
        <div class="stats-grid">
            <div class="stat-card fade-up">
                <span class="stat-number" data-count="{{ isset($data[0]->tahun_pengalaman) ? $data[0]->tahun_pengalaman : '25' }}">0</span>
                <span class="stat-label">
                    @if(isset($data[0]->label_pengalaman) && !empty($data[0]->label_pengalaman))
                        {{ $data[0]->label_pengalaman }}
                    @else
                        Tahun Pengalaman
                    @endif
                </span>
            ...
            <div class="stat-card fade-up" style="animation-delay: 0.1s;">
                <span class="stat-number" data-count="{{ isset($data[0]->jumlah_alumni) ? $data[0]->jumlah_alumni : '15000' }}">0</span>
                <span class="stat-label">
                    @if(isset($data[0]->label_alumni) && !empty($data[0]->label_alumni))
                        {{ $data[0]->label_alumni }}
                    @else
                        Alumni Sukses
                    @endif
            ...
            <div class="stat-card fade-up" style="animation-delay: 0.2s;">
                <span class="stat-number" data-count="{{ isset($data[0]->jumlah_program) ? $data[0]->jumlah_program : '50' }}">0</span>
                <span class="stat-label">
                    @if(isset($data[0]->label_program) && !empty($data[0]->label_program))
                        {{ $data[0]->label_program }}
                    @else
                        Program Studi
                    @endif
                </span>
            ...
            <div class="stat-card fade-up" style="animation-delay: 0.3s;">
                <span class="stat-number" data-count="{{ isset($data[0]->tingkat_kepuasan) ? $data[0]->tingkat_kepuasan : '95' }}">0</span>
                <span class="stat-label">
                    @if(isset($data[0]->label_kepuasan) && !empty($data[0]->label_kepuasan))
                        {{ $data[0]->label_kepuasan }}
                    @else
                        % Kepuasan
                    @endif
                </span>
...
<section class="signature-section">
    <div class="container">
        <div class="signature-card fade-up">
            <div class="signature-quote crimson">
                @if(isset($data) && count($data) > 0 && isset($data[0]->quote_penutup) && !empty($data[0]->quote_penutup))
                    "{{ $data[0]->quote_penutup }}"
                @else
                    "Bersama-sama kita wujudkan visi universitas yang unggul, 
                    berkelanjutan, dan memberikan dampak positif bagi kemajuan bangsa."
                @endif
            </div>
            
            <div class="signature-line"></div>
            
            @if(isset($data) && count($data) > 0 && isset($data[0]->nama))
                <div class="signature-name">{{ $data[0]->nama }}</div>
                @if(isset($data[0]->jabatan))
                    <div class="signature-title">{{ $data[0]->jabatan }}</div>
                @endif
            @else
                <div class="signature-name">Prof. Dr. Rektor</div>
                <div class="signature-title">Rektor Universitas Mercu Buana Yogyakarta</div>
            @endif
        </div>
    </div>
</section>
